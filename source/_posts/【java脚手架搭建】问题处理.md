...
![](http://ll-blog.oss-cn-hangzhou.aliyuncs.com/17-8-12/21388886.jpg)
...
```
![]( http://ll-blog.oss-cn-hangzhou.aliyuncs.com/17-8-12/19801636.jpg)


 - 标红问题，可以给项目加入`Spring`支持，就能关联到相关参数
![](http://ll-blog.oss-cn-hangzhou.aliyuncs.com/17-8-12/78509387.jpg)
...
![](http://ll-blog.oss-cn-hangzhou.aliyuncs.com/17-8-12/1533464.jpg)
```text
...
![](http://ll-blog.oss-cn-hangzhou.aliyuncs.com/17-8-12/46243355.jpg)



相关配置：（统一或者无版本配置[默认当前jar包版本]）
![](http://ll-blog.oss-cn-hangzhou.aliyuncs.com/17-8-12/88780676.jpg)
